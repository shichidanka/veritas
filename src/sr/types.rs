...
pub struct NOPBAAAGGLA {
    ...
    pub APDDLHNGGIM: AttackType,                       // 0x398
...
pub mod rpg {
    pub mod gamecore {
        ...
        pub struct BattleEventDataComponent {
            ...
            pub _HasSkill: bool,                                // 0xc0
            pub BattleEventTotalDamageType: TeamType,           // 0xc4
            pub WarningChallengeTurnLeft: u32,                  // 0xc8
        }
        #[repr(C)]
        #[derive(Debug, Clone, Copy)]
        ...
        pub struct SkillData {
            ...
            pub DefaultCoolDown: i32,                     // 0xb0
            pub AttackDamageTypePreshowAttach: [u8; 0x4], // 0xb4
            pub SkillConfigID: u32,                       // 0xb8
            pub AttackType: AttackType,                   // 0xbc
            pub SkillComboValueDelta: FixPoint,           // 0xc0
            pub MaxCastTimes: i32,                        // 0xc8
            pub AttackDamageTypeOverride: [u8; 0x4],      // 0xcc
            pub SkillIndex: i32,                          // 0xd0
            pub SkillEffect: *const c_void,               // 0xd4
        }
        #[repr(C)]
        #[derive(Debug, Clone, Copy)]
        pub enum TeamType {
