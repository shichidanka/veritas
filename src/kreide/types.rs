...
pub struct NOPBAAAGGLA {
    ...
    pub MDEHKOOKJCK: *const NativeList<NativeObject>,  // 0x38
...
pub struct EDJEDBLFIKE {
    ...
    pub PGPNDEIFMMF: *const NativeList<EDJEDBLFIKE>,   // 0x18
    pub BKOFKGCANPN: *const c_void,                    // 0x20
    pub PIJCPBGIEOC: *const NativeArray<NativeObject>, // 0x28
    pub LJHGLKMAPBE: *const TeamFormationComponent,    // 0x30
    pub OGBHOPFFGFP: *const GameEntity,                // 0x38
    pub DAGNFDKMDEF: *const NativeString,              // 0x40
    pub FLFNAFNNMBN: *const c_void,                    // 0x48
    pub MJEBCDHCGMH: *const EDJEDBLFIKE,               // 0x50
    pub LNILILLBCGC: *const NativeString,              // 0x58
    pub MBDGPOJNGFP: *const c_void,                    // 0x60
    pub MNIJEBNCBKB: *const GameEntity,                // 0x68
    pub CJAJFECDPPJ: *const GameEntity,                // 0x70
    pub PFPDENDBJKL: *const c_void,                    // 0x78
    pub LOHMAMHFIGP: *const GameEntity,                // 0x80
    pub EADOCJKPPBN: *const c_void,                    // 0x88
    pub PEKEMAPHMPK: *const c_void,                    // 0x90
    pub PAPNHNOOPMK: *const c_void,                    // 0x98
    pub HLEGPKNHFFM: *const c_void,                    // 0xa0
    pub ECHFEHNDOJF: *const NativeArray<NativeObject>, // 0xa8
    pub FLMDDGMPOIN: [u8; 0xc],                        // 0xb0
    pub ALBCLOBMAAA: i32,                              // 0xbc
    pub EAIAJIOPLDM: bool,                             // 0xc0
    pub IOLCGFPHNBM: bool,                             // 0xc1
    pub PMAHDELPGFH: bool,                             // 0xc2
    pub GDHEHGIAEFE: bool,                             // 0xc3
    pub FMJMBKNPLPA: f32,                              // 0xc4
    pub ODCPODIECFK: i32,                              // 0xc8
    pub IEFGFPBNLJE: i32,                              // 0xcc
    pub MLAHBDLNOAA: f32,                              // 0xd0
    pub MJFIGBNFCMP: bool,                             // 0xd4
    pub NJAKDBCILEM: bool,                             // 0xd5
    pub FCOAHCGBOPH: bool,                             // 0xd6
    pub LKBINIFLPIK: bool,                             // 0xd7
    pub HFNDIAFABLD: bool,                             // 0xd8
    pub CCKJAGJDNCK: bool,                             // 0xd9
    pub IsInit__BackingField: bool,                    // 0xda
    pub HBMKPLPDABN: bool,                             // 0xdb
    pub DEFJLDFMHJA: [u8; 0xc],                        // 0xdc
    pub KFKBEGPNBBA: u32,                              // 0xe8
    pub HOMHCNECBND: [u8; 0xc],                        // 0xec
    pub DMGGHOFAADK: i32,                              // 0xf8
    pub FMKFHCDFJFD: i32,                              // 0xfc
    pub JABPKHKIBHM: i32,                              // 0x100
    pub BFKAEAEMEIF: f32,                              // 0x104
    pub JPACGCDPCEP: f32,                              // 0x108
    pub BGPEBFGCIFI: [u8; 0xc],                        // 0x10c
    pub MNMBEKKJOPN: i32,                              // 0x118
    pub MOEFEJMBFHN: f32,                              // 0x11c
    pub FDNNGFMGPBH: f32,                              // 0x120
    pub FOMIFIJPOBA: f32,                              // 0x124
    pub PLAODOKPNKA: i32,                              // 0x128
    pub OJABHABFLKK: TeamType,                         // 0x12c
    pub ANGNPNFAMKA: [u8; 0xc],                        // 0x130
    pub DMGBPALONGL: f32,                              // 0x13c
}
#[repr(C)]
#[derive(Debug, Clone, Copy)]
...
pub mod rpg {
    ...
    pub mod client {
        ...
        pub struct AvatarData {
            pub native_object: NativeObject,
            pub HasTakenPromotionRewardList__BackingField: *const NativeList<u32>, // 0x10
            ...
            pub _SkinIDList: *const NativeList<u32>,                               // 0x80
        ...
        pub struct ModuleManager {
            ...
            pub _ModuleInitRequestList: *const NativeList<NativeObject>, // 0xa8
            ...
            pub modules: *const NativeList<NativeObject>, // 0x358
    ...
    pub mod gamecore {
        ...
        pub struct TeamFormationComponent {
            pub _parent_object: GameComponentBase,                  // 0x0
            pub _RecordFormationIndices: *const c_void,             // 0x18
            pub _FormationSnapshots: *const c_void,                 // 0x20
            pub _Random: *const c_void,                             // 0x28
            pub _multiRowTargetSelector: *const c_void,             // 0x30
            pub _CurrentUseTemplateConfigName: *const NativeString, // 0x38
            pub _AllTeammate: *const NativeList<GameEntity>,        // 0x40
            pub _LastRefreshLocationTemplateConfigName: *const NativeString, // 0x48
            pub WaveOfMonsterRuntimeID__BackingField: *const NativeList<u32>, // 0x50
            pub _CustomUpdateFormationDatas: *const NativeList<EDJEDBLFIKE>, // 0x58
            pub _GridFormationConfig: *const c_void,                // 0x60
            pub _FormationDatasNormal: *const NativeList<EDJEDBLFIKE>, // 0x68
            pub _CurrentLightTeamFightFormationConfig: *const c_void, // 0x70
            pub _UseCustomFormationMembers: *const c_void,          // 0x78
            pub _AllTeammateCopy: *const NativeList<GameEntity>,    // 0x80
            pub _FormationInCameraSpace: *const NativeList<GameEntity>, // 0x88
            pub _CurrentCustomFormationName: *const NativeString,   // 0x90
            pub _DefaultLocationExtCfgs: *const NativeArray<NativeObject>, // 0x98
            pub _TeamRefreshLocationContext: *const c_void,         // 0xa0
            pub _TeamFormationDatas: *const NativeList<EDJEDBLFIKE>, // 0xa8
            pub _CurrentDarkTeamFightFormationConfig: *const c_void, // 0xb0
            pub _DefaultFormationCenter: *const EDJEDBLFIKE,        // 0xb8
            pub _DefaultLocationExtCfgs2: *const NativeArray<NativeObject>, // 0xc0
            pub _CustomFormationCenterFromBoundBox: [u8; 0xc],      // 0xc8
            pub _ServantFormationState: i32,                        // 0xd4
            pub ComfortZoneWidthOverride__BackingField: f32,        // 0xd8
            pub TeamFaceDir__BackingField: f32,                     // 0xdc
            pub FormationCenterWorldPos__BackingField: [u8; 0xc],   // 0xe0
            pub _dataViewRestoreData: [u8; 0xc],                    // 0xec
            pub _InverseFlag: bool,                                 // 0xf8
            pub _CustomFormationCenterDirty: bool,                  // 0xf9
            pub _IsLocationDirty: bool,                             // 0xfa
            pub TeamRotation__BackingField: [u8; 0x10],             // 0xfc
            pub _Team: TeamType,                                    // 0x10c
            pub _TeamZOffset: f32,                                  // 0x110
            pub _MaxLocationCount: i32,                             // 0x114
            pub _CustomFormationCenter: [u8; 0xc],                  // 0x118
            pub _FormationForceWidthMax: f32,                       // 0x124
            pub FormationWidth__BackingField: f32,                  // 0x128
            pub _TeamDistanceCache: f32,                            // 0x12c
            pub LocationRootWorldPos__BackingField: [u8; 0xc],      // 0x130
            pub FormationCenterWorldPosFromBoundBox__BackingField: [u8; 0xc], // 0x13c
            pub LockFormationRefresh__BackingField: bool,           // 0x148
            pub _IsGridFightTeamFormation: bool,                    // 0x149
            pub _IsInited: bool,                                    // 0x14a
            pub _AutoBalanceDefaultFormation: bool,                 // 0x14b
            pub _gridUnitWidth: f32,                                // 0x14c
            pub _TeamActiveRowAliveStateFilter: [u8; 0x2],          // 0x150
            pub _IsTeammateDirty: bool,                             // 0x152
            pub _HasCustomTeamFormation: bool,                      // 0x153
            pub _RemoveVersionCounter: u32,                         // 0x154
            pub _LastDieTeammatePos: [u8; 0x8],                     // 0x158
            pub _FormationForceWidthMin: f32,                       // 0x160
            pub _CurrentFormationType: i32,                         // 0x164
            pub AliveEntitiesFormationCenterWorldPos__BackingField: [u8; 0xc], // 0x168
        }
        #[repr(C)]
        ...
        pub struct MonsterRowData {
            ...
            pub _TemplateRow: *const c_void,     // 0x18
            pub _EliteGroup2Row: *const c_void,  // 0x20
            pub _OverrideDisplay: [u8; 0x58],    // 0x28
            pub _Row: *const MonsterRow,         // 0x80
            pub _HardLevelRow: *const c_void,    // 0x88
            pub _SkillRowDatas: *const NativeList<NativeObject>, // 0x90
            pub _OverrideStanceWeakList: *const NativeArray<NativeObject>, // 0x98
            pub _EliteGroupRow: *const c_void,   // 0xa0
            pub _Json: *const CharacterConfig,   // 0xa8
            pub _BaseMonsterRow: *const MonsterRow, // 0xb0
            pub _MaxHP: FixPoint,                // 0xb8
            pub _MaxStance: [u8; 0x10],          // 0xc0
            pub _InitHP: FixPoint,               // 0xd0
            pub _InitStance: [u8; 0x8],          // 0xd8
        }
        #[repr(C)]
        #[derive(Debug, Clone, Copy)]
        pub struct TurnBasedAbilityComponent {
            ...
            pub OnAbilityPropertyChanged: *const NativeList<NativeObject>, // 0x30
            pub _BuffLockStepSources: *const NativeList<NativeObject>, // 0x38
            pub _ExtraMaxLayerConfig: *const NativeList<NativeObject>, // 0x40
            ...
            pub _SelfExtrAbilityList: *const NativeList<NativeString>, // 0x58
            pub Weakness: *const c_void,                          // 0x60
            pub _AbilityPropertiesInitSnapshot: *const NativeArray<FixPoint>, // 0x68
            pub RegardAsAttackTypeMap: *const NativeList<NativeObject>, // 0x70
            pub _KillerEntity: *const GameEntity,                 // 0x78
            pub _DebuffLockStepSources: *const NativeList<NativeObject>, // 0x80
            pub RegardAsSkillTypeMap: *const NativeList<NativeObject>, // 0x88
            pub ProjectileTargetAttachPoint: *const NativeString, // 0x90
            pub _DotModifierEventProcessors: *const NativeList<NativeObject>, // 0x98
            ...
            pub _EnergyPointEntries: *const NativeList<NativeObject>, // 0xc0
            ...
            pub _OnHitEffectMultipleOverride: *const NativeList<NativeObject>, // 0xe8
            pub _DamageStoreList: *const NativeList<NativeObject>, // 0xf0
            pub _JsonConfigRef: *const CharacterConfig,           // 0xf8
            pub DamageSplitData: *const NativeList<NativeObject>, // 0x100
            pub _StancePreshowConfigs: *const NativeList<NativeObject>, // 0x108
            pub _EnableNegativeHPSourceList: *const NativeList<NativeObject>, // 0x110
            pub _ModifierEventSourceMuteCounter: *const c_void,   // 0x118
            pub _LockHPList: *const NativeList<NativeObject>,     // 0x120
            pub _RedStanceInfoList: *const NativeList<NativeObject>, // 0x128
            pub CharmSkillName: *const NativeString,              // 0x130
            pub KillerSkill__BackingField: *const c_void,         // 0x138
            pub _DamagedEntityListInAttack: *const NativeList<GameEntity>, // 0x140
            pub _OnHitEffectOverride: *const NativeList<NativeObject>, // 0x148
            ...
            pub ResistModifierBehaviorFlags__BackingField: *const NativeList<NativeObject>, // 0x1c8
            pub _DepartedParams: *const NativeList<NativeObject>, // 0x1d0
            ...
            pub PropertyEnumBoundary__BackingField: AbilityProperty, // 0x25c
        ...
        pub struct BattleLineupData {
            ...
            pub MazeBuffAdded: *const NativeList<NativeObject>, // 0x20
        ...
        pub struct EntityManager {
            pub native_object: NativeObject,
            pub _EntityUniqueNameDict: *const NativeList<NativeObject>, // 0x10
        ...
        pub struct TurnBasedGameMode {
            ...
            pub _PhaseModifierList: *const NativeList<NativeObject>, // 0x38
            pub _LinkTeammateList: *const NativeList<GameEntity>, // 0x40
            pub _ActionEntityList: *const NativeList<GameEntity>, // 0x48
            pub StageBattleEventMgr__BackingField: *const c_void, // 0x50
            pub LastKillTargetList__BackingField: *const NativeList<GameEntity>, // 0x58
            pub _ActionDelayChangeStamp: [u8; 0x18], // 0x60
            pub _ModifierPerformCamerContext: *const c_void, // 0x78
            pub LastSummonMonsterList: *const NativeList<GameEntity>, // 0x80
            pub _ImmediateActionEntities: *const c_void, // 0x88
            pub _ActionEntityListSnapshot: *const NativeList<GameEntity>, // 0x90
            ...
            pub _AllOffTeamCharacters: *const NativeList<GameEntity>, // 0xb0
            ...
            pub _OverrieWaveMonsterPerformDatas: *const NativeList<NativeObject>, // 0xf0
            pub TurnActionDelayCostChangeSource__BackingField: *const GameEntity, // 0xf8
            pub _SkillAddBuffPerformList: *const NativeList<NativeObject>, // 0x100
            ...
            pub _InsertAbilityList: *const NativeList<MMNDIEBMDNL>, // 0x138
            pub _VersusBarMgr: *const c_void,     // 0x140
            pub _CurrentActionDelayModifyGroup: *const NativeList<GameEntity>, // 0x148
            pub _EntityCustomUnselectableDatas: *const NativeList<NativeObject>, // 0x150
            pub _UnselectableEntities: *const NativeList<GameEntity>, // 0x158
            ...
            pub _AllTeamCharacters: *const NativeList<GameEntity>, // 0x1a0
            ...
            pub _WaitingAbilityList: *const NativeList<NativeObject>, // 0x1c8
            pub OwnerBattleInstanceRef__BackingField: *const BattleInstance, // 0x1d0
            pub _InsertUltraSkillParamsQueue: *const NativeList<NativeObject>, // 0x1d8
            pub SkillUsageLog__BackingField: *const c_void, // 0x1e0
            pub _EvolveBuildGearMgr: *const c_void, // 0x1e8
            pub _LimboEntities: *const NativeList<NativeObject>, // 0x1f0
            ...
            pub _allowQuitStates: *const NativeList<NativeObject>, // 0x210
            pub _CurrentSkillCharacter: *const SkillCharacterComponent, // 0x218
            pub _LimboEntitiesWaitAbilityFinish: *const NativeList<NativeObject>, // 0x220
            ...
            pub PerformDelayExecuteList: *const NativeList<NativeObject>, // 0x240
            pub LastKillSkill__BackingField: *const c_void, // 0x248
            pub _SomatoModifierPerforms: *const NativeList<NativeObject>, // 0x250
            ...
            pub BattleResultState__BackingField: [u8; 0x8], // 0x280
            ...
            pub _RecordOperationByLG: [u8; 0x8],  // 0x2f0
        ...
        pub struct MonsterDataComponent {
            pub _parent_object: CharacterDataComponent,      // 0x0
            pub _CustomDataRef: *const c_void,               // 0x90
            pub _MonsterRowData: *const MonsterRowData,      // 0x98
            pub _CreateParams: *const c_void,                // 0xa0
            pub EnergyBarState: *const c_void,               // 0xa8
            pub _DefaultPhaseConfig: *const c_void,          // 0xb0
            pub _DefaultMaxStance: FixPoint,                 // 0xb8
            pub OverrideRankScore__BackingField: [u8; 0x10], // 0xc0
            pub _CurrentPhase: u32,                          // 0xd0
            pub _PhaseMaxHPStackIndex: i32,                  // 0xd4
            pub _DefaultMaxHP: FixPoint,                     // 0xd8
            pub _PhaseMaxStanceStackIndex: i32,              // 0xe0
            pub MonsterWave: i32,                            // 0xe4
            pub MonsterIndexInWave: i32,                     // 0xe8
            pub _CurrentPhaseHPRecovered: bool,              // 0xec
            pub IsMuteLastKill__BackingField: bool,          // 0xed
        }
        #[repr(C)]
        #[derive(Debug, Clone, Copy, PartialEq)]
        ...
        pub struct SkillCharacterComponent {
            pub _parent_object: GameComponentBase,                // 0x0
            pub _SkillDataList: *const NativeList<SkillData>,     // 0x18
            pub _CharacterDataRef: *const CharacterDataComponent, // 0x20
            pub _SkillTargetRedirectEntries: *const NativeList<NativeObject>, // 0x28
            ...
            pub CurrentAimAtTargetList: *const NativeList<GameEntity>, // 0x88
            pub CurrentSkillSubTargetList__BackingField: *const NativeList<GameEntity>, // 0x90
            pub CurrentAimAtMainTargetList: *const NativeList<GameEntity>, // 0x98
            pub OnSkillSetup: *const NativeList<NativeObject>,    // 0xa0
            pub _SkillTypeDisableSlots: *const c_void,            // 0xa8
            pub CurrentSkillTargetDamageHP: *const c_void,        // 0xb0
            pub CurrentAimAtSubTargetList: *const NativeList<GameEntity>, // 0xb8
        ...
        pub struct BattleInstance {
            pub native_object: NativeObject,
            pub BattleLogicRandom__BackingField: *const c_void, // 0x10
            pub _BattleLineupData: *const BattleLineupData,     // 0x18
            pub LogExport__BackingField: *const c_void,         // 0x20
            pub _GameWorld: *const c_void,                      // 0x28
            pub _BattleLineupDataPrimitive: *const BattleLineupData, // 0x30
            ...
            pub ComplexSkillAIConsiderUltra: bool,              // 0x48
            pub AutoBattleAtStart: bool,                        // 0x49
            pub IsBattleDirectKill__BackingField: bool,         // 0x4a
            pub EncryptTime__BackingField: bool,                // 0x4b
            pub LogicRandomSeed__BackingField: i32,             // 0x4c
            pub PlaneID__BackingField: u32,                     // 0x50
            pub BattleUnifiedAreaID__BackingField: u32,         // 0x54
            pub BattleAreaID__BackingField: u32,                // 0x58
            pub BattleID: u32,                                  // 0x5c
            pub ClientIFixVersion: u32,                         // 0x60
            pub BattleCheckResult: i32,                         // 0x64
            pub IsTeamFormationExpansion__BackingField: bool,   // 0x68
            pub IsBattleServerSimulator__BackingField: bool,    // 0x69
            pub DimensionID__BackingField: u32,                 // 0x6c
            pub FloorID__BackingField: u32,                     // 0x70
        }
        #[repr(C)]
        #[derive(Debug, Clone, Copy)]
        pub struct MonsterRow {
            pub native_object: NativeObject,
            pub DynamicValues: *const NativeArray<NativeObject>, // 0x10
            pub SummonIDList: *const NativeArray<u32>,           // 0x18
            pub SkillList: *const NativeArray<u32>,              // 0x20
            pub DamageTypeResistance: *const NativeArray<NativeObject>, // 0x28
            pub StanceWeakList: *const NativeArray<NativeObject>, // 0x30
            pub CustomValues: *const NativeArray<NativeObject>,  // 0x38
            pub _ExpandedDataRowCache: *const c_void,            // 0x40
            pub OverrideAIPath: *const NativeString,             // 0x48
            pub OverrideAISkillSequence: *const NativeArray<NativeObject>, // 0x50
            pub DebuffResist: *const NativeArray<NativeObject>,  // 0x58
            pub OverrideSkillParams: *const NativeArray<NativeObject>, // 0x60
            pub AbilityNameList: *const NativeArray<NativeString>, // 0x68
            pub CustomValueTags: *const NativeArray<NativeString>, // 0x70
            pub MonsterIntroduction: TextID,                     // 0x78
            pub HPModifyRatio: FixPoint,                         // 0x88
            pub MonsterBattleIntroduction: TextID,               // 0x90
            pub AttackModifyRatio: FixPoint,                     // 0xa0
            pub StanceCountDelta: i32,                           // 0xa8
            pub EliteGroup: u32,                                 // 0xac
            pub AttackModifyValue: FixPoint,                     // 0xb0
            pub DefenceModifyValue: FixPoint,                    // 0xb8
            pub StanceModifyValue: FixPoint,                     // 0xc0
            pub HPModifyValue: FixPoint,                         // 0xc8
            pub StanceModifyRatio: FixPoint,                     // 0xd0
            pub SpeedModifyValue: FixPoint,                      // 0xd8
            pub MonsterID: u32,                                  // 0xe0
            pub _IsCached: bool,                                 // 0xe4
            pub InheritDynamicValues: bool,                      // 0xe5
            pub SpeedModifyRatio: FixPoint,                      // 0xe8
            pub MonsterTemplateID: u32,                          // 0xf0
            pub InheritAbilityNameList: bool,                    // 0xf4
            pub InheritSummonIDList: bool,                       // 0xf5
            pub InheritCustomValues: bool,                       // 0xf6
            pub InheritCustomValueTags: bool,                    // 0xf7
            pub MonsterType: u32,                                // 0xf8
            pub MonsterName: TextID,                             // 0x100
            pub Level: u32,                                      // 0x110
            pub HardLevelGroup: u32,                             // 0x114
            pub DefenceModifyRatio: FixPoint,                    // 0x118
        }
        #[repr(C)]
        #[derive(Debug, Clone, Copy)]
        ...
        pub struct CharacterDataComponent {
            ...
            pub _DummpyEntityList: *const NativeList<NativeObject>, // 0x30
