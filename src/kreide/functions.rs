...
pub mod rpg {
    ...
    pub mod gamecore {
        ...
        pub static MonsterRowData_get_CharacterName: LazyLock<
            unsafe fn(*const MonsterRowData) -> *const TextID,
        > = lazy_initialize_address!(0x94f4eb0);
        pub static MonsterRowData_get_Level: LazyLock<unsafe fn(*const MonsterRowData) -> u32> =
    ...
    pub mod client {
        ...
        pub static AvatarModule_GetAvatar: LazyLock<unsafe fn(*const c_void, u32) -> *const AvatarData> =
