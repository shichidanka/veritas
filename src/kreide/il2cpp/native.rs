...
impl From<&str> for Il2CppString {    fn from(s: &str) -> Self {
...
impl From<String> for Il2CppString {    fn from(value: String) -> Self {
        Self::from(value.as_str())
    }
}

impl From<usize> for Il2CppString {    fn from(value: usize) -> Self {
        Self(value)
    }
}
...
impl Il2CppArray {    pub fn class(&self) -> Il2CppClass {
...
impl List {    pub fn class(&self) -> Il2CppClass {
        unsafe { Il2CppClass(*(self.0 as *const usize)) }
    }
    pub fn monitor(&self) -> usize {
        unsafe { *((self.0 + 8) as *const usize) }
    ...
    pub fn to_vec<T: Clone>(self) -> Vec<T> {
        unsafe {
            ...
            std::slice::from_raw_parts(items.first_item_ptr() as *const T, self.size() as usize).to_vec()
        }
    }
...
impl RuntimeField {    pub fn get_il2cpp_field(&self) -> Il2CppField {
